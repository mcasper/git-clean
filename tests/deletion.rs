...
fn test_git_clean_works_with_merged_branches() {
    ...
    project.batch_setup_commands(&["git checkout -b merged",
                                   "touch file2.txt",
                                   "git add .",
...
fn test_git_clean_works_with_squashed_merges() {
    ...
    project.batch_setup_commands(&["git checkout -b squashed",
                                   "touch file2.txt",
                                   "git add .",
...
fn test_git_clean_does_not_delete_branches_ahead_of_master() {
    ...
    project.batch_setup_commands(&["git checkout -b ahead",
                                   "touch file2.txt",
                                   "git add .",
                                   "git commit -am Ahead",
...
fn test_git_clean_works_with_squashes_with_flag() {
    ...
    // this condition.
    project.batch_setup_commands(&["git checkout -b github_squash",
                                   "touch squash.txt",
                                   "git add .",
